...
def test_find_support_fields_constraints(monkeypatch):
    ...
    with conn:
        with conn.cursor() as curs:
            curs.execute(
                ...
                CREATE UNIQUE INDEX "content_items_church_id_origin_id_origin_type" ON "public"."content_item"("church_slug","origin_id","origin_type");
                """
            )
    ...
    _, _, constraints = find_supported_fields(pg_hook, [], "content_item")
    assert constraints == ("origin_id", "church_slug", "origin_type")
