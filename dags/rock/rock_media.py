...
class Media:
    ...
    def get_media_value(self, content_item, attribute):
        ...
        formatted_value = content_item["AttributeValues"][attribute_key]["ValueFormatted"] or ""
        
        # This is true for images stored in assets stored in rock.
        if formatted_value and formatted_value.startswith("http") and attribute_value and not attribute_value.startswith("http"):
